                            ...
                            <div class="col-12 col-md-5">
                                <form action="" method="POST">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="title" class="form-control shadow-none" id="floatingInput" placeholder="Kategori Adı">
                                        <label for="floatingInput">Kategori Adı</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="icon" class="form-control shadow-none" id="floatingPassword" placeholder="Kategori İkonu">
                                        <label for="floatingPassword">Kategori İkonu</label>
                                    </div>
                                    <div class="form-group">
                                        <button name="addCategory" class="send-btn">Kategori Ekle</button>
                                    </div>
                                </form>
                            </div>
